...
"""
Replace with above for augmented videos if you need it
...
formatted_original_time, input_file_count = get_video_stats(input_folder)
...
formatted_final_time, output_file_count = get_video_stats(output_folder)
